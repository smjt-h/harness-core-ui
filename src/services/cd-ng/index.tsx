...
import type { StringsContextValue } from '@harness/uicore'
...
export interface PrimaryArtifact {
  spec: ArtifactConfig
  type: 'DockerRegistry' | 'Gcr' | 'Ecr' | 'Nexus3Registry' | 'ArtifactoryRegistry' | 'CustomArtifact' | 'Acr'
}
...
export interface ResponseGetFileResponse {
  correlationId?: string
...
export type UpdateApiKeyProps = Omit<
  MutateProps<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams>,
  'path' | 'verb'
> &
...
export const UpdateApiKey = ({ identifier, ...props }: UpdateApiKeyProps) => (
  <Mutate<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams>
    verb="PUT"
...
export type UseUpdateApiKeyProps = Omit<
  UseMutateProps<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams>,
  'path' | 'verb'
> &
  UpdateApiKeyPathParams
...
export const useUpdateApiKey = ({ identifier, ...props }: UseUpdateApiKeyProps) =>
  useMutate<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams>(
    'PUT',
...
export const updateApiKeyPromise = (
  {
    identifier,
    ...props
  }: MutateUsingFetchProps<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams> & {
    identifier: string
  },
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<ResponseApiKeyDTO, Failure | Error, UpdateApiKeyQueryParams, ApiKeyDTORequestBody, UpdateApiKeyPathParams>(
    'PUT',
    getConfig('ng/api'),
    `/apikey/${identifier}`,
    props,
...
/**
 * Gets the filtered list of files
 */
...
/**
 * Update file or folder via YAML
 */
...
export interface ValidateSshHostsQueryParams {
  accountIdentifier: string
  orgIdentifier?: string
  projectIdentifier?: string
  identifier: string
...
export type ValidateSshHostsProps = Omit<
  MutateProps<ResponseListHostValidationDTO, Failure | Error, ValidateSshHostsQueryParams, HostValidationParams, void>,
  'path' | 'verb'
>

/**
 * Validate SSH hosts connectivity
 */
export const ValidateSshHosts = (props: ValidateSshHostsProps) => (
  <Mutate<ResponseListHostValidationDTO, Failure | Error, ValidateSshHostsQueryParams, HostValidationParams, void>
    verb="POST"
    path={`/host-validation/ssh`}
    base={getConfig('ng/api')}
    {...props}
  />
)

export type UseValidateSshHostsProps = Omit<
  UseMutateProps<
    ResponseListHostValidationDTO,
    Failure | Error,
    ValidateSshHostsQueryParams,
 ...
 * Validate SSH hosts connectivity
 */
export const useValidateSshHosts = (props: UseValidateSshHostsProps) =>
  useMutate<ResponseListHostValidationDTO, Failure | Error, ValidateSshHostsQueryParams, HostValidationParams, void>(
    'POST',
    `/host-validation/ssh`,
    { base: getConfig('ng/api'), ...props }
  )
 ...
 * Validate SSH hosts connectivity
 */
export const validateSshHostsPromise = (
  props: MutateUsingFetchProps<
    ResponseListHostValidationDTO,
    Failure | Error,
    ValidateSshHostsQueryParams,
  ...
  mutateUsingFetch<
    ...
    HostValidationParams,
    void
  >('POST', getConfig('ng/api'), `/host-validation/ssh`, props, signal)
...
export const useCreatePR = (props: UseCreatePRProps) =>
  useMutate<ResponseCreatePRDTO, Failure | Error, CreatePRQueryParams, GitPRCreateRequest, void>('POST', `/scm/createPR`, {
    base: getConfig('ng/api'),
    ...props
  })
...
export type GetFileProps = Omit<GetProps<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>, 'path'>

/**
 * get file
 */
export const GetFile = (props: GetFileProps) => (
  <Get<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>
    path={`/scm/get-file`}
    base={getConfig('ng/api')}
    {...props}
  />
...
export type UseGetFileProps = Omit<
  UseGetProps<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>,
  'path'
>
 ...
 * get file
 */
export const useGetFile = (props: UseGetFileProps) =>
  useGet<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>(`/scm/get-file`, {
    base: getConfig('ng/api'),
    ...props
  })
...
export const getFilePromise = (
  props: GetUsingFetchProps<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>,
  signal?: RequestInit['signal']
) =>
  getUsingFetch<ResponseGetFileResponse, Failure | Error, GetFileQueryParams, void>(
    getConfig('ng/api'),
    `/scm/get-file`,
    props,
    signal
...
export interface SaveSourceCodeManagersQueryParams {
  accountIdentifier: string
}

export type SaveSourceCodeManagersProps = Omit<
  MutateProps<ResponseSourceCodeManagerDTO, Failure | Error, SaveSourceCodeManagersQueryParams, SourceCodeManagerDTORequestBody, void>,
  'path' | 'verb'
>
...
export const SaveSourceCodeManagers = (props: SaveSourceCodeManagersProps) => (
  <Mutate<ResponseSourceCodeManagerDTO, Failure | Error, SaveSourceCodeManagersQueryParams, SourceCodeManagerDTORequestBody, void>
    verb="POST"
    path={`/source-code-manager`}
    base={getConfig('ng/api')}
    {...props}
...
export type UseSaveSourceCodeManagersProps = Omit<
  UseMutateProps<ResponseSourceCodeManagerDTO, Failure | Error, SaveSourceCodeManagersQueryParams, SourceCodeManagerDTORequestBody, void>,
  'path' | 'verb'
>
...
export const useSaveSourceCodeManagers = (props: UseSaveSourceCodeManagersProps) =>
  useMutate<ResponseSourceCodeManagerDTO, Failure | Error, SaveSourceCodeManagersQueryParams, SourceCodeManagerDTORequestBody, void>(
    'POST',
    `/source-code-manager`,
    { base: getConfig('ng/api'), ...props }
  )
...
export const saveSourceCodeManagersPromise = (
  props: MutateUsingFetchProps<
    ...
    Failure | Error,
    SaveSourceCodeManagersQueryParams,
    SourceCodeManagerDTORequestBody,
    void
  >,
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<ResponseSourceCodeManagerDTO, Failure | Error, SaveSourceCodeManagersQueryParams, SourceCodeManagerDTORequestBody, void>(
    'POST',
    getConfig('ng/api'),
    `/source-code-manager`,
    props,
...
export interface UpdateSourceCodeManagersQueryParams {
  accountIdentifier: string
}
...
export type UpdateSourceCodeManagersProps = Omit<
  MutateProps<
    ResponseSourceCodeManagerDTO,
    Failure | Error,
    UpdateSourceCodeManagersQueryParams,
    SourceCodeManagerDTORequestBody,
