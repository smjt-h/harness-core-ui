...
export interface GitPRCreateRequest {
  accountIdentifier?: string
  gitXSimplificationFlow?: boolean
  orgIdentifier?: string
  projectIdentifier?: string
  sourceBranch: string
  targetBranch: string
...
export interface ResponseScmGetFileResponseDTO {
  correlationId?: string
  data?: ScmGetFileResponseDTO
  metaData?: { [key: string]: any }
  status?: 'SUCCESS' | 'FAILURE' | 'ERROR'
}
...
export interface ScmGetFileResponseDTO {
  blobId?: string
  commitId?: string
  fileContent?: string
}
...
export type CreatePRV2Props = Omit<
  MutateProps<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>,
  'path' | 'verb'
>
...
export const CreatePRV2 = (props: CreatePRV2Props) => (
  <Mutate<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>
    verb="POST"
...
export type UseCreatePRV2Props = Omit<
  UseMutateProps<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>,
  'path' | 'verb'
>
...
export const useCreatePRV2 = (props: UseCreatePRV2Props) =>
  useMutate<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>(
    'POST',
...
export const createPRV2Promise = (
  props: MutateUsingFetchProps<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>,
  signal?: RequestInit['signal']
) =>
  mutateUsingFetch<ResponseCreatePRResponse, Failure | Error, void, CreatePRRequest, void>(
    'POST',
    getConfig('ng/api'),
    `/scm/create-pull-request`,
    props,
...
export type GetFileProps = Omit<
  GetProps<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>,
  'path'
>
...
export const GetFile = (props: GetFileProps) => (
  <Get<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>
    path={`/scm/get-file`}
    base={getConfig('ng/api')}
    {...props}
  />
...
export type UseGetFileProps = Omit<
  UseGetProps<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>,
  'path'
>
...
export const useGetFile = (props: UseGetFileProps) =>
  useGet<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>(`/scm/get-file`, {
    base: getConfig('ng/api'),
    ...props
  })
...
export const getFilePromise = (
  props: GetUsingFetchProps<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>,
  signal?: RequestInit['signal']
) =>
  getUsingFetch<ResponseScmGetFileResponseDTO, Failure | Error, GetFileQueryParams, void>(
    getConfig('ng/api'),
    `/scm/get-file`,
    props,
    signal
