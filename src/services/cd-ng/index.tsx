...
export type DeploymentTemplateServiceSpec = ServiceSpec & {
  metadata?: string
}
...
export interface ResponseListServiceDefinitionType {
  correlationId?: string
  data?: ('Kubernetes' | 'NativeHelm' | 'Ssh' | 'WinRm' | 'DeploymentTemplate')[]
  metaData?: { [key: string]: any }
  status?: 'SUCCESS' | 'FAILURE' | 'ERROR'
}
...
export interface ServiceDefinition {
  spec: ServiceSpec
  type: 'Kubernetes' | 'NativeHelm' | 'Ssh' | 'WinRm' | 'DeploymentTemplate'
}
...
export interface GetStepsQueryParams {
  serviceDefinitionType: 'Kubernetes' | 'NativeHelm' | 'Ssh' | 'WinRm' | 'DeploymentTemplate'
}
