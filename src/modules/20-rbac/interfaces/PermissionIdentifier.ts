...
export enum PermissionIdentifier {
  ...
  VIEW_ENVIRONMENT_GROUP = 'core_environment_group_view',
  EDIT_ENVIRONMENT_GROUP = 'core_environment_group_edit',
  DELETE_ENVIRONMENT_GROUP = 'core_environment_group_delete',
  RUNTIMEACCESS_ENVIRONMENT_GROUP = 'core_environment_group_access',
