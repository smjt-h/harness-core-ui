...
const ResourceGroupScope: React.FC<ResourceGroupScopeProps> = ({ includedScopes, setIncludedScopes, setIsUpdated }) => {
    ...
    <Card className={css.card}>
      <Layout.Vertical spacing="medium">
        <Layout.Horizontal spacing="small" flex={{ alignItems: 'center', justifyContent: 'flex-start' }}>
          ...
          >
            {getSelectedScopeLabel(getString, scope, includedScopes)}
          </Text>
        </Layout.Horizontal>
