      ...
      <PageBody loading={isListFetching || isFetchingCcmMetaData || isSummaryDataFetching}>
        ...
        >
          ...
          <AnomaliesSummary
            ...
            isAnomaliesSummaryError={isAnomaliesSummaryError ? Boolean(isAnomaliesSummaryError) : null}
          />
          <AnomaliesListGridView
            ...
            isAnomaliesListError={isAnomaliesListError ? Boolean(isAnomaliesListError) : null}
          />
        </Container>
      </PageBody>
    </>
