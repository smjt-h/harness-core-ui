...
import type { ServiceNowCreateVariableListModeProps, ServiceNowCreateData } from './types'
...
export class ServiceNowCreate extends PipelineStep<ServiceNowCreateData> {
  ...
  validateInputSet({
    ...
    //   errors.spec = {
    //     ...errors.spec,
    //     projectKey: getString?.('pipeline.ServiceNowApprovalStep.validations.project')
    //   }
    // }
    ...
    //   errors.spec = {
    //     ...errors.spec,
    //     summary: getString?.('pipeline.ServiceNowCreateStep.validations.summary')
    //   }
    // }
