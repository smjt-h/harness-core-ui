...
import type { ServiceNowCreateDeploymentModeProps } from '@pipeline/components/PipelineSteps/Steps/ServiceNowCreate/types'
...
function FormContent(formContentProps: ServiceNowCreateDeploymentModeProps): JSX.Element {
