...
export const resetForm = (formik: FormikProps<ServiceNowUpdateData>, parent: string) => {
...
export const processFieldsForSubmit = (values: ServiceNowUpdateData): ServiceNowCreateFieldType[] => {
