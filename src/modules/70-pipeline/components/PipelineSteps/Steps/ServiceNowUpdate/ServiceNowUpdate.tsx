...
import ServiceNowUpdateDeploymentMode from './ServiceNowUpdateDeploymentMode'
...
import type {
  ...
  ServiceNowCreateVariableListModeProps
} from '@pipeline/components/PipelineSteps/Steps/ServiceNowCreate/types'
import ServiceNowUpdateStepModeWithRef
  from '@pipeline/components/PipelineSteps/Steps/ServiceNowUpdate/ServiceNowUpdateStepMode'
...
export class ServiceNowUpdate extends PipelineStep<ServiceNowCreateData> {
  constructor() {
    super()
  ...
  renderStep(this: ServiceNowUpdate, props: StepProps<ServiceNowCreateData>): JSX.Element {
    const {
      initialValues,
      onUpdate,
      stepViewType,
