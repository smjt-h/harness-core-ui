...
const isFirstNodeAGroupNode = (intersectingIndex: number, collapseOnIntersect = false): boolean =>
  intersectingIndex === 0 && collapseOnIntersect // if intersecting index is 0 and collapseOnIntersect is enabled
