...
describe('TargetingRulesTab', () => {
  ...
  test('it should render target groups tags/dropdown correctly', async () => {
    ...
    const targetGroupTagInputValue = screen.getByTestId('false_target_groups').querySelectorAll('span[data-tag-index]')
  ...
  test('it should render empty target groups input when variation segmentsundefined', async () => {
    ...
    const targetGroupTagInputValue = screen.getByTestId('false_target_groups').querySelector('span[data-tag-index="0"]')
