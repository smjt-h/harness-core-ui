...
describe('Test ServerlessDeployStep snapshots -  inputSet view', () => {
  ...
  test('Serverless Deploy Step rendering properly with initial values for inputsetView', () => {
    const { container } = render(
      <TestStepWidget
        initialValues={getInitialValues()}
        type={StepType.ServerlessAwsLambdaDeploy}
...
describe('ServerlessDeploy step tests - inputSet view', () => {
  ...
  test('should render skipDryRun checkbox field when skipDryRun is made runtime', async () => {
    ...
    const accordionHeder = await findByText('cd.serverlessDeployCommandOptions')
...
describe('ServerlessDeploy step tests - edit view', () => {
  ...
  test('should call onChange if valid values entered - edit view', async () => {
  ...
  test('should not call onChange if valid values entered but onChange is undefined - edit view', async () => {
    const onChangeHandler = jest.fn()
    const ref = React.createRef<StepFormikRef<unknown>>()
    const { container } = render(
      <TestStepWidget
  ...
  test('should render skipDryRun checkbox field when skipDryRun is made runtime - Edit view', async () => {
    const ref = React.createRef<StepFormikRef<unknown>>()
    const { findByText } = render(
      <TestStepWidget
        initialValues={getInitialValues()}
